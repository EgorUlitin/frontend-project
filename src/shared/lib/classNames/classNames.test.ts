...
describe('classNames', () => {
    ...
    test('with all params', () => {
        ...
        expect(classNames('app', { isDisable: true, hover: true }, ['ligth'])).toBe(expected);
    });
    test('with one mod is false', () => {
        const expected = 'app isDisable ligth';
        expect(classNames('app', { isDisable: true, hover: false }, ['ligth'])).toBe(expected);
    });
    test('with one mod is undefined', () => {
        const expected = 'app hover ligth';
        expect(classNames('app', { isDisable: undefined, hover: true }, ['ligth'])).toBe(expected);
    });
});
